...
@test tics(20, 80, 600, 0.03) == (0.04159722222222222, 1//4)
@test tics(25, 75, 500, 0.02) == (0.02772222222222222, 10//60)
@test tics(10, 12, 25, 0.01) == (0.016666666666666666, 5//60)
@test tics(20, 80, 6000, 0.03) == (0.055546296296296295, 2//60)
@test tics(30, 60, 200, 0.02, true) == (0.02763888888888889, 1//60)
@test tics(60, 70, 125, 0.001) == (0.0017222222222222222, 5//600)
@test tics(10, 12, 25, 0.01, true) == (0.01, 2//600)
@test tics(130, 180, 1000, 0.0004) == (0.000555, 1//600)
@test tics(60, 70, 5500//2, 0.003) == (0.003818055555555556, 5//6000)
@test tics(30, 150, 4000, 0.002, true) == (0.0027770833333333337, 2//6000)
@test tics(9.5, 14.5, 5000, 0.002) == (0.002777222222222222, 1//6000)
