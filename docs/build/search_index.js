...

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "AstroLib is available for Julia 0.4 and later versions, and can be installed with Julia's built-in package manager. In a Julia session run the commandjulia> Pkg.add(\"AstroLib\")You may need to update your package list with Pkg.update() in order to get the latest version of AstroLib.jl.Note that, in order to work, a few functions require external files, which are automatically downloaded when building the package. Should these files be missing for some reason, you will be able to load the package but some functions may not work properly. You can manually build the package withjulia> Pkg.build(\"AstroLib\")"
},
...
{
    "location": "ref.html#AstroLib.deredd-Tuple{Real,Real,Real,Real,Real}",
    "page": "Reference",
...
{
    "location": "ref.html#AstroLib.eci2geo-Tuple{Real,Real,Real,Real}",
    "page": "Reference",
...
{
    "location": "ref.html#AstroLib.gal_uvw-Tuple{Real,Real,Real,Real,Real,Real}",
    "page": "Reference",
...
{
    "location": "ref.html#AstroLib.geo2eci-Tuple{Real,Real,Real,Real}",
    "page": "Reference",
...
{
    "location": "ref.html#AstroLib.geo2geodetic-Tuple{Real,Real,Real,Real,Real}",
    "page": "Reference",
...
{
    "location": "ref.html#AstroLib.geodetic2geo-Tuple{Real,Real,Real,Real,Real}",
    "page": "Reference",
...
{
    "location": "ref.html#AstroLib.precess-Tuple{Real,Real,Real,Real}",
    "page": "Reference",
...
{
    "location": "ref.html#AstroLib.precess_xyz-Tuple{Real,Real,Real,Real,Real}",
    "page": "Reference",
...
{
    "location": "ref.html#AstroLib.rhotheta-Tuple{Real,Real,Real,Real,Real,Real,Real,Real}",
    "page": "Reference",
...
{
    "location": "ref.html#AstroLib.sphdist-Tuple{Real,Real,Real,Real}",
    "page": "Reference",
...
{
    "location": "ref.html#AstroLib.tenv",
    "page": "Reference",
    "title": "AstroLib.tenv",
    "category": "Function",
    "text": "ten(deg[, min, sec]) -> decimal\nten(\"deg:min:sec\") -> decimal\ntenv([deg], [min], [sec]) -> decimal\ntenv([\"deg:min:sec\"]) -> decimal\n\nPurpose\n\nConverts a sexagesimal number or string to decimal.\n\nExplanation\n\nten is the inverse of the sixty function.  tenv is the vectorial version of ten.\n\nArguments\n\nten takes as argument either three scalars (deg, min, sec) or a string. The string should have the form \"deg:min:sec\" or \"deg min sec\".  Also any iterable like (deg, min, sec) or [deg, min, sec] is accepted as argument.\n\nIf minutes and seconds are not specified they default to zero.\n\ntenv takes as input three numerical arrays of numbers (minutes and seconds arrays default to null arrays if omitted) or one array of strings or iterables.\n\nOutput\n\nThe decimal conversion of the sexagesimal numbers provided is returned.  The output has the same dimension as the input.\n\nMethod\n\nThe formula used for the conversion is\n\nmathrmsign(mathrmdeg)left(mathrmdeg + fracmathrmmin60 + fracmathrmsec3600right)\n\nExample\n\nten(-0.0, 19, 47)\n# => -0.3297222222222222\nten(\"+5:14:58\")\n# => 5.249444444444444\nten(\"-10 26\")\n# => -10.433333333333334\nten((-10, 26))\n# => -10.433333333333334\n\nNotes\n\nThese functions cannot deal with -0 (negative integer zero) in numeric input. If it is important to give sense to negative zero, you can either make sure to pass a floating point negative zero -0.0 (this is the best option), or use negative minutes and seconds, or non-integer negative degrees and minutes.\n\n\n\n"
